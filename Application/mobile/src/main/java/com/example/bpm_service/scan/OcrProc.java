...
public class OcrProc {
    ...
    public static String main(String ocrApiUrl, String ocrSecretKey, String imageData) {
        ...
        try {
            ...
            String message = getReqMessage(imageData);
    ...
    public static String getReqMessage(String imageData) {
