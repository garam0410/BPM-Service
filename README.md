 ...
 **이 밖에도 많은 사례들이 존재합니다. 지금까지 나온 서비스나 사례는 모두 단순히 심박수만을 측정해서 최대, 최소만을 다루고 있습니다. 최대, 최소 뿐만 아니라 실시간으로 저장되는 심박수를 분석해서 사람마다 무서운정도가 다르다는 것까지 고려하여 보다 정확한 지표를 제공할 것입니다.**
